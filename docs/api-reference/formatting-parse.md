...
Sometimes you just want to parse the value that is stored and show what user typed. **Note:** when doing this you may need to pass an initialization function, see example below.
