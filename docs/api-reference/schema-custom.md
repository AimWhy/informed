...
Informed comes with a custom schema adapter that maps field types to actual JSX elements. Whenever you create your own inputs, you have to create or add to informd's fieldMap.
