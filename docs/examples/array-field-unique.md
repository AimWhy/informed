# `ArrayField Unique Validation`

Sometimes you need to validate that all fields in an array are unique. **Note:** how we pass validateWhen as a function instead of an array. **Note:** To test, type Matt in the second name field :)
