# `Conditional Options Schema`

Informed allows you to use conditional change the options of input fields. Try selecting different options from "Would you like a car or truck?" and observe the "Product" dropdown.
