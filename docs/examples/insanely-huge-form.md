...
Sometimes you want to build an absurdly huge form! This one has 3k fields!!

Note: In this example we use "SimpleInput" as its a bare bones html input ( does not use a design system whos implementation details might be non performant )
