...
Informed allows you to pass a JSON schema to the form and it will render out the form accoding to the adapter configured.
...
How did it know? It knew what to render based on an adapter. Informed has a default adapter but more often than not you will create your own adapter that maps to your components.
...
Then when you wrap your form component you pass the adapter.
